...
function selectActiveInstrument(instId) {
  ...
  // Atualiza destaque nos cards da sidebar
  document.querySelectorAll(".instrument-card").forEach(card => {
    card.classList.toggle("active", card.dataset.instrumentId === instId);
  });

  // Atualiza destaque em todas as linhas da grade
...
// ==========================================
// 5. EVENTOS E INTERATIVIDADE (Com Troca Contextual ao Clicar na Grade)
// ==========================================
...
function setupGridEvents() {
  ...
  scoreGrid.addEventListener("click", (e) => {
    ...
    // Se o clique foi na linha de outro instrumento, troca automaticamente
